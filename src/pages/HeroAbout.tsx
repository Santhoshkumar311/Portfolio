...
export default function HeroAbout() {
  return (
    <MainLayout>
      <SEO title="SANTHOSH's Portfolio" description="3D icons, particles, and animated gradient blurs introducing who I am and what I do." />
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            <div className="relative">
              <img
                ...
                alt="Santhosh Kumar - Frontend Developer"
          ...
          >
            ...
            <div className="space-y-6">
             ...
             I’m a Computer Science graduate with a strong interest in frontend development. Skilled in Java, HTML, CSS, JavaScript, and React.js, I enjoy building responsive, user-friendly web applications and have worked on projects like an AI-based CopBot and multiple React-based applications.
             </p>
            </div>
            {/* About Me Section 
