  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "santhoshsanthoshktk25@gmail.com",
      link: "mailto:santhaoshsanthoshktk25@gmail.com"
    },
    {
      icon: Phone,
      label: "Phone",
      value: "+91 6369433384",
      link: "tel:+91 6369433384"
    },
    {
      icon: MapPin,
      label: "Location",
  ...
  const socialLinks = [
    {
      icon: Github,
      label: "GitHub",
      url: "https://github.com/Santhoshkumar311",
      color: "hover:text-gray-600"
    },
    {
      icon: Linkedin,
      label: "LinkedIn",
      url: "https://www.linkedin.com/in/santhoshkumar-k-71723729b/",
      color: "hover:text-blue-600"
    },
    {
      icon: Instagram,
      label: "Instagram",
      url: "https://www.instagram.com/______santhosh311_____?igsh=MXFyNDA3c2I5dXg4Mg==",
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="pt-6 border-t border-border/20">
                ...
                <div className="mb-4">
                  <a 
                    href="https://github.com/Santhoshkumar311"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-primary hover:text-primary/80 transition-colors font-medium"
                  >
                  https://www.linkedin.com/in/santhoshkumar-k-71723729b/
                  </a>
                </div>
