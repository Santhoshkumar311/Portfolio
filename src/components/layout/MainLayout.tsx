...
const social = [
  { href: "https://github.com/Santhoshkumar311", Icon: Github, label: "GitHub" },
  { href: "https://www.linkedin.com/in/santhoshkumar-k-71723729b/", Icon: Linkedin, label: "LinkedIn" },
  { href: "http://www.instagram.com/______santhosh311_____?igsh=MXFyNDA3c2I5dXg4Mg==", Icon: Instagram, label: "Instagram" },
];
    ...
    <div className="relative min-h-screen overflow-x-hidden flex flex-col">
      ...
      <header className="sticky top-0 z-40 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b">
        <nav className="container mx-auto flex items-center justify-between py-3 px-4">
          <Link to="/" className="font-semibold tracking-wide hover-scale text-lg"> Santhosh's Portfolio</Link>
      ...
      <footer className="border-t py-6 mt-auto">
        <div className="container mx-auto px-4 sm:px-6 flex justify-center">
          <p className="text-sm text-muted-foreground">© 2025 Santhosh | frontend developer</p>
        </div>
      </footer>
    </div>
  );
